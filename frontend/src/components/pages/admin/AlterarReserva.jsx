            ...
            <Flex align="center" justify="center" w="full">
              <Box background="gray.200" w="50%" p="8" rounded="3xl">
                ...
                <ModalContent>
                  ...
                  <ModalCloseButton />
                  <ModalBody>
                    <Text>Selecione abaixo o que você deseja fazer com essa reserva</Text>
                    <Select mt="4" placeholder='Selecione um novo status' value={novoStatus} onChange={(e)=>verificaMotivo(e)}>
                      <option value='APROVADO'>Aprovado</option>
                      <option value='CANCELADO'>Cancelado</option>
                      <option onClick={()=>console.log('negado')} value='NEGADO'>Negado</option>
                    </Select>
                    <Textarea mt="8" display="none" placeholder="Insira o motivo pelo qual a reserva foi negada." id="textarea">
                  ...
                  <ModalFooter>
                    ...
                    <Button colorScheme="whatsapp" onClick={handleTrocaStatus}>Confirmar novo status</Button>
                  </ModalFooter>
                </ModalContent>
              </Modal>
