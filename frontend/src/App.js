...
import AlterarReserva from "./components/pages/admin/AlterarReserva";
  ...
  return (
    <Box>
      <Routes>
        ...
        <Route
          path="/admin/atualizar-produto/:id"
        ...
        <Route
          path="/cliente/adicionar-reserva"
          element={<AdicionarReserva />}
        />
        <Route path="/admin/tipos" element={<AdminTipos />} />
        <Route path="/admin/reservas" element={<AdminReservas />} />
        <Route path="/admin/reservas/:id" element={<AlterarReserva />} />
